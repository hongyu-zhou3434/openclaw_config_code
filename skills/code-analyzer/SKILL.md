...
| 内容项 | 说明 | 示例 |
|--------|------|------|
| **模型名称** | 官方名称和版本 | GPT-4、Claude 3、Kimi k1.5 |
| **发布机构** | 开发公司/组织 | OpenAI、Anthropic、月之暗面 |
| **发布时间** | 发布日期 | 2024-03、2025-01 |
| **模型类型** | 基础分类 | 大语言模型、多模态模型、推理模型 |
| **参数量级** | 模型规模 | 7B、70B、1.8T |
| **上下文窗口** | 支持的最大token数 | 128K、200K、1M |
